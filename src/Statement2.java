...
public class Statement2 extends StatementSecondary {
    ...
    private void createNewRep() {
        ...
        //a new statement is just a block. It's a tree of statement labels
        
        
        this.rep = new Tree1<>();
         
        //assemble the tree with kind;
        StatementLabel s = new StatementLabel(Kind.BLOCK);
        
        this.rep.assemble(s, this.rep.newSequenceOfTree());
        
        //just creates a tree with a child that's a block.
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        //extract representation from statement, then add the rep to subtree
        //cast statement s to statement2
        
        Statement2 localS = (Statement2) s;
        //addToSubtree add the statement to the block at this subtree
    ...
    public final int lengthOfBlock() {
        ...
        length = this.rep.numberOfSubtrees();
    ...
    public final Condition disassembleIfElse(Statement s1, Statement s2) {
        ...
        //don't remove child one. Remove child 0 twice.
    ...
    public final void assembleCall(String inst) {
        ...
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        StatementLabel sl = new StatementLabel(Kind.CALL, inst);
